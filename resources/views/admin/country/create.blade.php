...
@section('title',__('country::country.add_country'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('country::country.add_country') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('country::country.add_country') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="currency_code" name="currency_code"
                                       required
                                       value="{{ old('currency_code') }}" tabindex="6"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="currency_sub_unit"
                                       ...
                                       value="{{ old('currency_sub_unit') }}" tabindex="7"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="currency_symbol"
                                       ...
                                       value="{{ old('currency_symbol') }}" tabindex="8"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="currency_decimals"
                                       ...
                                       value="{{ old('currency_decimals') }}" tabindex="9"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="currency_rate"
                                       ...
                                       value="{{ old('currency_rate') }}" tabindex="10"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="calling_code"
                                       ...
                                       value="{{ old('calling_code') }}" tabindex="11"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="region_code"
                                       ...
                                       value="{{ old('region_code') }}" tabindex="12"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="sub_region_code"
                                       ...
                                       value="{{ old('sub_region_code') }}" tabindex="13"
